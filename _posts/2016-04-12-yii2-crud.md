...
这里对Yii2.0数据库简单的增删改查语法做个小结，一方面是对自己学习的总结，另外以便于后面查询。这里附一个Yii2的速查表，写的非常不错，可以快递找到自己想要找的知识点，地址：[https://www.yii-china.com/doc/detail/539](https://www.yii-china.com/doc/detail/539)
